...
Widget.Dialog.prototype = {
    ...
    getWindow: function (height, width) {
        ...
        dwindow.style.border = '4px solid #1777b1';
        dwindow.style.borderRadius = '15px';
        dwindow.style.padding = '6px';
        dwindow.style.textAlign = 'left';
        dwindow.style.fontFamily = 'arial';
        dwindow.style.fontSize = '12px';
        return dwindow;
    },
