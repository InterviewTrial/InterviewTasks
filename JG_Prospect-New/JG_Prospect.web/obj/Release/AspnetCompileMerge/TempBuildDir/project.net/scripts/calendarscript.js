...
function updateEvent(event, element) {
    ...
    $("#eventfname").va(event.fname);
    $("#eventlname").val(event.lname);
    $("#eventDesignation").val(event.Designation);
...
$(document).ready(function() {
    ...
    $('#calendar').fullCalendar({
        ...
        eventRender: function(event, element) {
            ...
            element.qtip({
                content: {
                    text: qTipText(event.start, event.end,event.fname, event.description),
