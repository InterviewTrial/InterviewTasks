<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="calendar.aspx.cs" Inherits="JG_Prospect.calendar.calendar" %>
...
<head runat="server">
    ...
    <style type="text/css">
        ...
        #Panel1 ul.weather_list li > span
        {
            display: inline-block;
            padding: 0 5px;
        }
        #Panel1 ul.weather_list li > span.date, #Panel1 ul.weather_list li > span.image
        {
            display: block;
            padding: 0;
        }
        #Panel1 ul.weather_list li > span.desc
        {
            display: none;
        }
    </style>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function displayEvent(event) {
            ...
            eventHtml.push('<div id="edit"><a id="lnkedit" href="/Prospectmaster.aspx?title=' + title + '" target="_parent" runat="server">Edit Prospect</a></div>');
