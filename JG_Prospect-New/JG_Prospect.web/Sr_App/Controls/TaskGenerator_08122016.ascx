                                ...
                                <ContentTemplate>
                                    <div>
                                        <asp:GridView ID="gvSubTasks" runat="server" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-HorizontalAlign="Center"
                                            ...
                                            <AlternatingRowStyle CssClass="AlternateRow " />
                                            <Columns>
                                                <asp:BoundField DataField="InstallId" HeaderText="List ID" HeaderStyle-Width="9%" />
                                                ...
                                                <asp:TemplateField HeaderText="Hrs. Est" HeaderStyle-Width="6%">
                                                    <ItemTemplate>
                                                        <%# Eval("Hours") %>
                                                    </ItemTemplate>
                                                    <HeaderStyle Width="5%" />
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RegularExpressionValidator ID="revHours" runat="server" ControlToValidate="txtHours" Display="None"
                            ErrorMessage="Please enter decimal numbers for hours of task." ValidationGroup="Submit" ValidationExpression="\d*"  />
