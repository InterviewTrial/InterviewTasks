<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TaskGenerator_Old.ascx.cs" Inherits="JG_Prospect.Sr_App.Controls.TaskGenerator" %>
...
<div id="divModal" title="Task : Title" style="background: #efeeee url(../img/form-bg.png) repeat-x top; display: none;">
                ...
                <tr id="trSubTaskList" runat="server" visible="false">
                    <td colspan="4">
                        <fieldset class="tasklistfieldset">
                            ...
                            <br />
                                                    <asp:TextBox ID="txtSubTaskTitle" runat="server" Width="100%" CssClass="textbox" />
                            ...
                            <br />
                                                    <asp:TextBox ID="txtSubTaskDescription" runat="server" CssClass="textbox" TextMode="MultiLine" Rows="5" Width="100%" />
                                            ...
                                            <tr>
                                                <td>Due Date:
                            <asp:TextBox ID="txtSubTaskDueDate" runat="server" CssClass="textbox" />
    ...
    <script>
        ...
        function copytoListID(link) {
            if ($(this).text()) {
                $('#<%= txtTaskListID.ClientID %>').val($(this).text());
            }
