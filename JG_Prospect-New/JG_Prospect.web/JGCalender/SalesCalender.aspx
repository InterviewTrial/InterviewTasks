                    ...
                    if (test.toString() != "") {
                        try {
                            ...
                            for (var x = 0; x < test.length; x++) {
                                ...
                                //This will create a pop-up for customer's  profile page
                                var marker = new google.maps.InfoWindow({
                                    content: PageMethods.ReturnHtml("http://localhost:61394/Sr_App/Customer_Profile.aspx?CustomerId=" + test[x].customerid, updateSuccess),
                                    maxWidth: 200
                                });

                                waypts.push({
                                    location: test[x].address,
                                    stopover: true
                                });
                            ...
                            directionsService.route({
                                origin: test[0].address,
                                destination: test[test.length - 1].address,
                                waypoints: waypts,
