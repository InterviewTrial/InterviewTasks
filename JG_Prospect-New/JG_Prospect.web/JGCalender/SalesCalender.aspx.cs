...
namespace JG_Prospect.JGCalender
{
    ...
    public partial class SalesCalender : System.Web.UI.Page
    {
        ...
        public static string GetCustomers()
        {
            ...
            return oSerializer.Serialize(EventDAO.getCustomers());
        }
        ...
        public static string UpdateEvent(CalendarEvent cevent)
        {
            ...
            if (idList != null && idList.Contains(cevent.id))
            {
                ...
                {
                    EventDAO.updateEvent(cevent.id, cevent.title, cevent.description, cevent.status);
        ...
        {
            return true;//Regex.IsMatch(str, @"^[a-zA-Z0-9 ]*$");
        }
        protected void chkNew_CheckedChanged(object sender, EventArgs e)
        {
            Response.Redirect("~/Sr_App/new_customer.aspx");
        }
}
