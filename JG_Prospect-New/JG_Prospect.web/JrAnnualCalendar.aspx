<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JrAnnualCalendar.aspx.cs" MasterPageFile="~/JG.Master" Inherits="JG_Prospect.JrAnnualCalendar" %>
  ...
  <%--  <div class="left_panel arrowlistmenu">
    ...
    <div class="right_panel">
        <ul class="appointment_tab">
            ...
            <li><a id="A4" href="JrAnnualCalendar.aspx" runat="server" class="active">Annual Event Calendar</a></li>
        </ul>
        <h1>
            <b>Dashboard</b></h1>
        <h2>
