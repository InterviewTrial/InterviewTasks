...
namespace JG_Prospect.DAL
{
    public class InstallUserDAL
    {
        ...
        public DataSet ChangeSatatus(string Status, int StatusId, string RejectionDate, string RejectionTime, int RejectedUserId, string StatusReason = "", string UserIds = "")
        {
            DataSet dsTemp = new DataSet();
            try
            {
