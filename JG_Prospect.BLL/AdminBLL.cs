...
namespace JG_Prospect.BLL
{
    public class AdminBLL
    {
        ...
        {
            return AdminDAL.Instance.FetchContractTemplate(id, desig);
        }
        
        public DataSet GetEmailTemplate(String pTemplateName)
        {
            return AdminDAL.Instance.GetEmailTemplate(pTemplateName, 0);
        }
        ...
        public bool UpdateContractTemplate(string ContracttemplateHeader, string ContracttemplateBodyA, string ContracttemplateBodyB, string ContracttemplateFooter, string ContractTemplateBody2, int id, int desigID)
        {
            return AdminDAL.Instance.UpdateContractTemplate(ContracttemplateHeader, ContracttemplateBodyA, ContracttemplateBodyB, ContracttemplateFooter, ContractTemplateBody2, id, desigID);
        }
