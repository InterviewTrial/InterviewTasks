...
namespace JG_Prospect.BLL
{
    public class InstallUserBLL
    {
        ...
        public DataSet ChangeStatus(string Status, int StatusId, string RejectionDate, string RejectionTime, int RejectedUserId, string StatusReason = "", string UserIds = "")
        {

            return InstallUserDAL.Instance.ChangeSatatus(Status, StatusId, RejectionDate, RejectionTime, RejectedUserId, StatusReason, UserIds);
        }
